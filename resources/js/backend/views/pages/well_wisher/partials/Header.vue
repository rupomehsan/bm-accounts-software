        ...
        <div class="main-header-right row" header-bg-color="bg-default-light-colo">
            <div class="mobile-sidebar col-1 ps-0">
                <div class="text-start switch-sm">
                    <label class="switch"><input type="checkbox" id="sidebar-toggle" v-model="toggleSwitch"
                            :checked="toggleSwitch" /><span class="switch-state"></span></label>
                </div>
            </div>
            <div class="nav-right col">
                <ul class="nav-menus">
                    <li class="onhover-dropdown mx-3">
                        <router-link :to="{ name: 'MyNotification' }" class="txt-dark">
                            ...
                            <span class="badge rounded-pill badge-primary notification">0</span>
                        </router-link>
                        <ul class="notification-dropdown onhover-show-div">
                            <li>
                                Notification
                                <span class="badge rounded-pill badge-secondary text-white text-uppercase pull-right">0
                                    New</span>
                            </li>
                            <li>
                                <div class="d-flex">
                            ...
                            <li class="text-center">
                                You have Check
                                <router-link :to="{ name: 'MyNotification' }" href="#">all</router-link>
                                notification
                            </li>
                        </ul>
                    </li>
