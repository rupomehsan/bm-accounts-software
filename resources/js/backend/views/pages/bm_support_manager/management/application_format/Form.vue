                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 text-end">
                            <div class="btns">
                                <router-link
                                    :to="{
                                        name: `bmSupportApplicationFormatAll`,
                                    }"
                        ...
                        <div class="card-body">
                            <div class="row justify-content-start">
                                ...
                                <div class="col-lg-6">
                                    <div>
                                        <div
                                            class="d-flex justify-content-between align-items-betwen my-2"
                                        >
                                    ...
                                    <template
                                        v-for="(field, index) in extra_fields"
                                        :key="index"
                                    >
                                        <div
...
export default {
            ...
            if (this.single_data && this.single_data.length > 0) {
                if (this.single_data[0].cp_application_category_id) {
                    this.form_fields[0].value =
                        this.single_data[0].cp_application_category_id;
                }
    ...
    methods: {
        ...
        submitHandler: async function ($event) {
            if (this.param_id) {
                this.application_format_update(
                    $event.target,
                    this.param_id,
                    this.extra_fields
                );
                this.$router.push({ name: `bmSupportApplicationFormatAll` });
            } else {
                let response = await this.application_format_store(
                    $event.target,
                    this.extra_fields
                );
