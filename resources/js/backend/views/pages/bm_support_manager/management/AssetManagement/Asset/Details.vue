            ...
            <div class="container-fluid">
                <div class="page-header">
                    <div class="row">
                        ...
                        <div class="col-lg-6 text-end">
                            <div class="btns">
                                <router-link
                                    :to="{ name: `bmSupportAll${route_prefix}` }"
                ...
                <div class="my-1">
                    <div class="">
                        <div>
                            <img
                                class="my-2 bg-light rounded shadow"
                                :src="single_data.asset_image"
                                alt=""
                                width="100"
                            />
                        </div>
                        <div class="row">
                                        ...
                                        >
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{
                                                            single_data.owner_phone_number
                                                        }}
                                                    </td>
                                                </tr>
                                                <tr>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    ...
                                    <div
                                        class="card-body p-2"
                                        v-if="single_data.asset_audit_list"
                                    >
                                        <table
                                            class="table table-hover table-striped"
                                        >
                                ...
                                <div class="card">
                                    <div class="card-header p-2">
                                        <b>Asset Items Information</b>
                                    </div>
                                    <div
                                        class="card-body p-2"
                                        v-if="single_data.asset_items?.length"
                                    >
                                        <table
                                            class="table table-hover table-striped"
                                        >
                                ...
                                <div class="card">
                                    <div class="card-header p-2">
                                        <b>Asset Transfer Information</b>
                                    </div>
                                    <div
                                        class="card-body p-2"
                                        v-if="single_data.asset_transfer"
                                    >
                                        <table
                                            class="table table-hover table-striped"
                                        >
                                ...
                                <div class="card">
                                    <div class="card-header p-2">
                                        <b>Lost Information</b>
                                    </div>
                                    <div
                                        class="card-body p-2"
                                        v-if="single_data.asset_lost"
                                    >
                                        <table
                                            class="table table-hover table-striped"
                                        >
        ...
        submitHandler: async function ($event) {
            if (this.param_id) {
                ...
                if (response.data.status === "success") {
                    ...
                    this.$router.push({ name: `bmSupportAll${this.route_prefix}` });
                }
            } else {
