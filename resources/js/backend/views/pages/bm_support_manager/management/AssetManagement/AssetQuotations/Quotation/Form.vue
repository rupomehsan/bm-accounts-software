                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <button
                                                    type="button"
                                                    class="btn btn-sm btn-success float-end mt-2"
                                                    style="height: 30px"
                                                    @click="
                                                        addProductDetails(index)
                                                    "
                                                >
                                                    <i class="fa fa-plus"></i>
                                                </button>
                                            ...
                                            >
                                                ...
                                                >
                                                    <div
                                                        class="admin_form form_1 card p-2"
                                                    >
                                                        <input
                                                            type="hidden"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <img
                                                                ...
                                                                class="mx-3"
                                                                :src="
                                                                    productDetails.quotation_image !=
                                                                    ''
                                                                        ? productDetails.quotation_image
            ...
            if (this.single_data) {
                ...
                if (this.single_data.quotation_product) {
                    this.form_fields[1].value =
                        this.single_data.quotation_product.title;
                }
                if (
                    this.single_data.quotation_product_price &&
                    this.single_data.quotation_product_price.length > 0
                ) {
                    this.prductData = [];
                    this.single_data?.quotation_product_price?.forEach(
                        (item, index) => {
                            const {
                                product_id,
                                id,
    ...
    methods: {
        ...
        removeProductDetailsItem: async function (data) {
            ...
            if (this.param_id) {
                ...
                this.prductData[data.index].details.splice(
                    data.detailsIndex,
                    1
                );
            }
