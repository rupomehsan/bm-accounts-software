                    ...
                    <div class="table-responsive card-body text-nowrap">
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody class="table-border-bottom-0">
                                <tr v-for="(item, index) in all_kendriosuvakanghi_income_data" :key="item.id">
...
export default {
    ...
    methods: {
        ...mapActions(report_setup_store, {
            get_all_kendriosuvakanghi_income: "get_all_kendriosuvakanghi_income",
        }),
        SubmitHandler() {
    ...
    computed: {
        ...mapState(report_setup_store, {
            all_kendriosuvakanghi_income_data: "all_kendriosuvakanghi_income_data",
        }),
    },
