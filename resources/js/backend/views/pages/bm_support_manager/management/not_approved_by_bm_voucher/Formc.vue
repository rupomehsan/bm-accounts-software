                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 text-end">
                            <div class="btns">
                                <router-link
                                    :to="{
                                        name: `bmSupportNotApprovedByCpVoucher`,
                                    }"
                        ...
                        <div class="card-body">
                            <div class="row justify-content-center">
                                <div class="col-lg-12">
                                    ...
                                    <div
                                        class="py-3 col-8 d-flex justify-content-between align-items-center"
                                    >
                                        <span>Support voucher list</span>
                                        <i
                                            class="icon-plus border p-2 rounded"
                                            @click="addSupportVoucher"
                                        ></i>
                                    </div>
                                    <div
                                        class="admin_form form_1"
                                        v-for="(item, index) in support_voucher"
                                        :key="index"
                                    >
                                        <input
                                            v-if="param_id"
    ...
    methods: {
        ...
        submitHandler: async function ($event) {
            if (this.param_id) {
                ...
                if (response.data.status === "success") {
                    ...
                    let targetAmount = document.querySelector(
                        `[data-amount="${index}"]`
                    );
                    let targetImage = document.querySelector(
                        `[data-image="${index}"]`
                    );
                    ...
                    if (existingError && existingError.tagName === "P") {
                        ...
                        targetAmount.insertAdjacentElement(
                            "afterend",
                            error_section
                        );
                    }
                    ...
                    if (
                        ...
                        error_section.innerText = "This field is required";
                        error_section.setAttribute("class", "my-2 text-danger");
                        targetImage.insertAdjacentElement(
                            "afterend",
                            error_section
                        );
                    }
        ...
        addSupportVoucher() {
            if (this.support_voucher.length < 10) {
                ...
                window.s_alert(
                    "Sorry, you are not allowed to add more than 10."
                );
            }
        },
        ...
        async deleteSupportVoucher(data) {
            if (data.is_id) {
                ...
                this.support_voucher = this.support_voucher.filter(
                    (item, i) => i !== data.index
                );
            }
        },
