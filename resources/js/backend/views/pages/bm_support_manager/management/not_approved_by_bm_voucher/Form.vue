                    ...
                    <div class="container-fluid">
                        <div class="page-header">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h6>
                                        Status Update voucher
                                    </h6>
                                </div>
                                <div class="col-lg-6 text-end">
                                    <div class="btns">
                                        <router-link :to="{ name: `${role}NotApprovedByBmVoucher` }"
                ...
                <div class="col-3">
                    <div class="card mt-2">
                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                            ...
                            <span class="text-info">{{ single_user.approved_by_sp_bm ? 'Approved' : 'Pending'
                                }}</span>
                        </div>
                        <div class="card-body m-0 p-2">
                            <form @submit.prevent="ApprovalSubmitHandler">
                                <input type="hidden" name="id" :value="param_id">
                                <input type="hidden" name="approved_by_sp_bm" value="1">
                                <div class="mb-3">
                                ...
                                <div>
                                    <button type="submit" class="btn btn-sm px-2 text-sm btn-primary">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            if (this.single_user) {
                this.form_fields.forEach((field, index) => {
                    Object.entries(this.single_user).forEach((value) => {
                        ...
                        if (value[0] == 'approved_by_sp_bm') {
                            this.voucher_status = value[1] == 0 ? 'approved' : 'canceled'
                        }
