        ...
        <div class="py-2">
            <div class="container-fluid">
                <div class="page-header">
                    <div class="row">
                        <div class="col-lg-6">
                            <h6>একাউন্ট গ্রুপ তৈরি করুন</h6>
                        </div>
                        <div class="col-lg-6 text-end">
                            <div class="btns">
                                <router-link
                                    :to="{ name: `${role}AllAccoutGroup` }"
...
import { account_group_setup_store } from "./setup/store";
export default {
    data: () => ({
        role: window.role.bm,
        form_fields,
    ...
    methods: {
        ...mapActions(account_group_setup_store, {
            user_update: "update",
            user_get: "get",
            account_store: "store",
        }),
        ...
        submitHandler: async function ($event) {
            if (this.param_id) {
                ...
                this.$router.push({ name: `${this.role}AllAccoutGroup` });
            } else {
    ...
    computed: {
        ...mapState(account_group_setup_store, {
