                    ...
                    <div class="card list_card">
                        <div class="card-header">
                            <form @submit.prevent="SubmitHandler($event)" ref="myForm">
                                <input type="hidden" name="type" value="income" id="">
                            ...
                            <div class="table_actions">
                                ...
                                <ul>
                                    <li>
                                        <a href=""
                                            @click.prevent="incomeExpenseStatementExport(statement_data?.statements)">
...
export default {
    ...
    methods: {
        ...
        incomeExpenseStatementExport(data = [], prefix_name = 'income_statement') {
