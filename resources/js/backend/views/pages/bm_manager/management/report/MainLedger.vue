                ...
                <div class="col-md-6">
                    <div class="conatiner">
                        <div class="card list_card">
                            <div
                                class="card-header align-items-center justify-content-bitween"
                            >
                                <h5>জমার খাতা</h5>
...
export default {
    ...
    methods: {
        ...
        formatDate(date) {
            ...
            const formattedDate = `${dateParts[1].padStart(
                2,
                "0"
            )}-${dateParts[0].padStart(2, "0")}-${dateParts[2]}`;
