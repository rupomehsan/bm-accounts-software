...
export const kollan_tohobil_income_setup_store = defineStore("kollan_tohobil_income_setup_store", {
    state: () => ({
        all_data: {},
        single_data: {},
    ...
    actions: {
        ...
        main_ledger: async function (form) {
            ...
            let response = await axios.post("get-income-ledger-by-category?category_type=kollan_tohobil", formData);
