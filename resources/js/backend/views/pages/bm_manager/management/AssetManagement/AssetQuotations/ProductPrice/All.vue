                        ...
                        <table class="table table-hover table-bordered">
                            <thead class="table-light">
                                <tr class="t-head">
                                    ...
                                    <th class='cursor_n_resize'> product </th>
                                    <th class='cursor_n_resize'> asset quotation </th>
                                    <th class='cursor_n_resize'> shope name </th>
                                    <th class='cursor_n_resize'> address </th>
                                    <th class='cursor_n_resize'> shop contact </th>
                                    <th class='cursor_n_resize'> price </th>
                                    <th class='cursor_n_resize'> quotation image </th>
                            ...
                            <tbody class="table-border-bottom-0" v-if="loaded">
                                <tr v-for="(item, index) in all_data.data" :key="index">
                                    ...
                                    <td>{{ item.id }}</td>
                                    <th class='cursor_n_resize'> {{ item.product?.title }} </th>
                                    ...
                                    <th class='cursor_n_resize'>
                                       <img :src="item.quotation_image" class="border" alt="" height="20" width="40">
                                    </th>
