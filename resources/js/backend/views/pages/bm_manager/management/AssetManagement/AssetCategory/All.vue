                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody class="table-border-bottom-0" v-if="loaded">
                                <tr v-for="(item, index) in all_data.data" :key="item.id">
                                    ...
                                    <td>
                                        <img :src="item.image" alt="" height="20" width="30">
                                    </td>
...
import { asset_category_setup_store } from './setup/store';
...
export default {
    ...
    methods: {
        ...mapActions(asset_category_setup_store, {
            get_all_data: 'all',
            delete_data: 'delete',
        ...
        ExportData(data = [], prefix_name = 'asset_category') {
            let dataArray = []
            data.forEach((item) => {
                let temp = {}
                temp.id = item.id
    ...
    computed: {
        ...mapState(asset_category_setup_store, {
            all_data: 'all_data',
            api_url: 'api_url',
        })
    },
