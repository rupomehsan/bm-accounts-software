...
export default {
    ...
    created: async function () {
        ...
        if (this.all_asset_quotation_data) {
            this.form_fields.forEach((field, index) => {
                if (field.name == 'asset_quotation_id') {
                    field.data_list = []
                    this.all_asset_quotation_data.forEach((value) => {
                        let dataList = {}
                        dataList.value = value.id
                        dataList.label = value.title
                        field.data_list.push(dataList)
    ...
    computed: {
        ...mapState(asset_request_to_cp_setup_store, {
            ...
            all_asset_quotation_data: 'all_asset_quotation_data',
        }),
    },
