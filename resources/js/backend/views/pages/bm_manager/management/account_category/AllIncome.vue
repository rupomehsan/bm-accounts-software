        ...
        <div class="pt-2">
            <div class="page-header my-2">
                <div class="row align-items-center rounded-2">
                    <div class="col-lg-6">
                        <h5 class="m-0">আয়ের খাত সমূহ</h5>
                    </div>
                    <div class="col-lg-6 text-end">
                        <span>
                            <router-link :to="{ name: `${role}CreateIncomeAccountCategory` }"
...
import { account_income_category_setup_store } from "./setup/store";
...
export default {
    ...
    methods: {
        ...mapActions(account_income_category_setup_store, {
            get_all_categories: "allIncome",
            user_delete: "delete",
    ...
    computed: {
        ...mapState(account_income_category_setup_store, {
            all_users: "all_data",
            api_url: "api_url",
        }),
