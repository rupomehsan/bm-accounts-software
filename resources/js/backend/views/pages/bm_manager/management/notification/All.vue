                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody class="table-border-bottom-0">
                                <tr v-for="item in all_notifications.data" :key="item.id">
                                    ...
                                    <!-- <td>
                                        <span :class="item.seen ? 'text-success' : 'text-warning'"
                                            class=" me-1 cursor_pointer">{{ item.seen == 0 ? "Unseen" : 'Seen' }}</span>
                                    ...
                                    <td>
                                        <div class="table_actions">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="" @click.prevent @click="notificationDetails(item.id)">
