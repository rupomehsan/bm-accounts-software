        ...
        <div class="pt-2">
            <div class="page-header my-2">
                <div class="row align-items-center rounded-2">
                    <div class="col-lg-6">
                        <h5 class="m-0">Pending Vouchers</h5>
                    </div>
            ...
            <div class="conatiner">
                <div class="card list_card">
                    ...
                    <div class="card-footer py-1 border-top-0 d-flex justify-content-between border border-1">
                        <pagination :data="all_users" :method="get_all_pending_vouchers" />
...
export default {
    ...
    created: async function () {
        await this.get_all_pending_vouchers();
        this.loaded = true
    },
    methods: {
        ...mapActions(voucher_setup_store, {
            get_all_pending_vouchers: "get_all_pending_vouchers",
            user_delete: "delete",
