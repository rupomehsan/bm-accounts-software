...
export const receipt_book_setup_store = defineStore("receipt_book_setup_store", {
    state: () => ({
        all_data: {},
        single_data: {},
    ...
    actions: {
        ...
        get_receipt_book_by_status: async function (status) {
            let response = await axios.get(this.api_route + "?is_approvel=" + status);
            // console.log("data", response);
            this.all_data = response.data.data;
        },
        ...
        update: async function (form, id) {
            let formData = new FormData(form);
            let response = await axios.post(this.api_route + `/${id}?_method=PATCH`, formData);
        ...
        delete: async function (id) {
            ...
            if (data) {
                let response = await axios.delete(this.api_route + "/" + id);
