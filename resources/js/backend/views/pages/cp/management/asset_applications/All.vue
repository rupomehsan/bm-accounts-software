        ...
        <div class="pt-2">
            <div class="page-header my-2">
                <div class="row align-items-center rounded-2">
                    <div class="col-lg-6">
                        <h5 class="m-0">Asset Application Management</h5>
                    </div>
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody class="table-border-bottom-0">
                                <tr v-for="(item, index) in all_users.data" :key="item.id">
                                    ...
                                    <td>
                                        <router-link
                                            :to="{ name: 'Applications', params: { type: 'approved', id: item.id } }"
                                            title="approved"><span class="fw-bold"> {{
                                                item.cp_application_approved_count ?? 0 }}</span></router-link>
                                    </td>

                                    <td>
                                        <router-link
                                            :to="{ name: 'Applications', params: { type: 'disapproved', id: item.id } }"
                                            title="disapproved">
                                            <span class="fw-bold"> {{
