                ...
                <div class="page-header">
                    <div class="row">
                        ...
                        <div class="col-lg-6 text-end">
                            <div class="btns">
                                <router-link :to="{ name: `CpAllVouchers` }"
                    ...
                    <div class="card my-2" v-for="(item, index) in top_shit_data.supportVoucher" :key="index">
                        <div class="card-body">
                            <table class="table text-light table-bordered">
                                <thead>
                                    <tr>
                                        <td colspan="3" class="fw-bold">ভাউচার</td>
                                    </tr>
                                    <tr>
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="2">
                                            কথায় : {{ convertAmount(item?.reduce((t, i) => (t += i.amount), 0)) }} টাকা
                                            মাত্র
                                        </td>
