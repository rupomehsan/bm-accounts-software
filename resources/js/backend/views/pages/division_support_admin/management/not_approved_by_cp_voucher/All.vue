        ...
        <div>
            <div class="page-header my-2">
                <div class="row align-items-center rounded-2">
                    <div class="col-lg-6">
                        <h5 class="m-0">Not Approved By Cp Voucher</h5>
                    </div>
            ...
            <div class="conatiner">
                <div class="card list_card">
                    ...
                    <div class="card-footer py-1 border-top-0 d-flex justify-content-between border border-1">
                        <pagination :data="all_users" :method="get_all_data" />
...
import { not_approved__by_cp_voucher_setup_store } from "./setup/store";
...
export default {
    ...
    methods: {
        ...mapActions(not_approved__by_cp_voucher_setup_store, {
            get_all_data: "all",
            user_delete: "delete",
    ...
    computed: {
        ...mapState(not_approved__by_cp_voucher_setup_store, {
            all_users: "all_data",
        }),
    },
    watch: {
