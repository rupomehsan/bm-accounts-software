...
export const not_approved__by_admin_voucher_setup_store = defineStore("not_approved__by_admin_voucher_setup_store", {
    state: () => ({
        all_data: {},
        single_data: {},
    ...
    actions: {
        all: async function (url) {
            ...
            if (url) {
                ...
                response = await axios.get("approval-voucher?admin=true");
            }
