            ...
            handler: function (v) {
                ...
                switch (this.role.name) {
                    ...
                    case "bm_support_manager":
                        window.location.hash = prev_url || "#/bm-support-manager";
                        break;
                    case "cp":
                    ...
                    case "division_support_admin":
                        window.location.hash = prev_url || "#/division-support-admin";
                        break;
                    case "division_without_audit":
                        window.location.hash = prev_url || "#/division-without-audit";
                        break;
                    case "branch":
                    ...
                    case "division_employee":
                        window.location.hash = prev_url || "#/division-employee";
                        break;
                    case "well_wisher":
